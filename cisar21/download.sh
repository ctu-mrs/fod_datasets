...
URL_INTERCEPTOR=https://nasmrs.felk.cvut.cz/index.php/s/5lsvY1tZXyXU7a9
URL_TARGET=https://nasmrs.felk.cvut.cz/index.php/s/2MkQCtAFbxiv8G8/download

# URLs for files and their respective subdirectories
URL=( "$URL_INTERCEPTOR" "$URL_TARGET" )
DATA_FOLDERS=( "interceptor" "target" )
######################################################
